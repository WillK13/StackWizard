...
## Install
	Pip
Mac: pip install stackwizard
Windows: python -m pip install stackwizard
Link https://pypi.org/project/stackwizard/
Conda conda install -c conda-forge stackwizard
## Uses
